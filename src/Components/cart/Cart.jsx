...
const Cart = () => {
    ...
    const getinddata = async () => {
        ...
        const res = await fetch(`http://localhost:10000/getproductsone/${id}`, {
            method: "GET",
            headers: {
        ...
        data.tokens=String(localStorage.getItem("token"))
    ...
    const addtocart = async (id) => {
        console.log(id);
        const check = await fetch(`http://localhost:10000/addcart/${id}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
                ...
                <div className="cart_container">
                    <div className="left_cart">
                        ...
                        <div className="cart_btn">
                            ...
                            <button className="cart_btn2" onClick={gotobuynow}>Buy Now</button>
                        </div>
