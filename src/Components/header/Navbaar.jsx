...
const Navbaar = () => {
    ...
    const getdetailsvaliduser = async () => {
        const res = await fetch("http://localhost:10000/validuser", {
            method: "GET",
            headers: {
   ...
   /* useEffect(() => {
    ...
    const logoutuser = async () => {
        const res2 = await fetch("http://localhost:10000/logout", {
            method: "GET",
            headers: {
                Accept: "application/json",
                "Content-Type": "application/json"
                ...
                <div className="right">
                    ...
                    <div className="menu_div">
                        ...
                        >
                            ...
                            {account ? <MenuItem /*</Menu>onClick={handleClose}*/ style={{ margin: 10 }} onClick={logoutuser}><LogoutIcon style={{ fontSize: 16, marginRight: 3 }} />   Logout</MenuItem> : ""}
                        </Menu>
                    </div>
                    <ToastContainer />
                </div>
